<template>
  <main class="background-wrap">
    ...
    <!-- GitHub -->
    <a
      class="flex items-center justify-center w-96 m-auto"
    ...
    >
      ...
      <h1 class="font-bold text-4xl text-gray-300  hover:text-purple-500 my-6">
        GitHub
      </h1>
    </a>
    <br />
    ...
    >
      ...
      <h1 class="font-bold text-4xl text-gray-300  hover:text-red-400 my-6">
        YouTube
      </h1>
    </a>
    <br />
    ...
    <a
      class="flex items-center  justify-center  w-96 m-auto"
      href="https://velog.io/@yhdc"
    >
      <img class="mr-3" src="../assets/velog_logo.png" width="50" height="50" />
      <h1 class="font-bold text-4xl text-gray-300  hover:text-green-400 my-6">
        Velog
      </h1>
    </a>
    <!-- <div class="w-full text-center mt-3 mb-8">
